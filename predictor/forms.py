...
class HeartDiseaseForm(forms.Form):
    ...
    trestbps = forms.FloatField(label='TRESTBPS', min_value=0, max_value=200, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    chol = forms.FloatField(label='CHOL', min_value=0, max_value=350, widget=forms.NumberInput(attrs={'class': 'form-control'}))
    ...
    thalach = forms.FloatField(label='THALACH', min_value=0, max_value=200, widget=forms.NumberInput(attrs={'class': 'form-control'}))
